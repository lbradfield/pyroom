...
class Polygon(object):
    ...
    def __init__(self, points):
        ...
        for v_x, v_y in points:
            self.vertices.append((float(v_x), float(v_y)))
            self.int_vertices.append((self.to_int(v_x), self.to_int(v_y)))
    ...
    def to_float(i, power=1):
        ...
        logger.debug("i: {}, power: {} -> raw_f: {}".format(i, power, raw_f))
    ...
    def to_int(f, power=1):
        ...
        logger.debug("f: {}, power: {} -> big_f: {}".format(f, power, big_f))
    ...
    def calc_centroid(vertices, area):
        ...
        area as integers.
        """
        logger.debug("vertices: {}, area: {}".format(vertices, area))
        c_x = 0
        c_y = 0
        num_vertices = len(vertices)
    ...
    def rotate_point(point, angle, origin=(0, 0)):
        ...
        int_origin = (Polygon.to_int(origin[0]), Polygon.to_int(origin[1]))
        ...
        logger.debug("int rotated point: {}".format((new_x, new_y)))
        logger.debug(
            "rotated point: {}".format(
